        ...
        if (req.body.type == 'chart') {
            switch (req.body.options.chartType) {
                ...
                case "WordCloud":
                    ...
                    break;
                case "Bigram":
                    const BigramWordCloud = require('./charts/BigramWordCloud'); // Import the BigramWordCloud class
                    const objBigramWordCloud = new BigramWordCloud(); // Create an instance of the BigramWordCloud class
                    return objBigramWordCloud.getData(req.body.options.config); // Call the getData method for bigram chart
                    break;
                case "Box":
